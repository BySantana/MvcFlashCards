...
namespace MvcFlashCards
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISeedUserRoleInicial, SeedUserRoleInicial>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ISeedUserRoleInicial seedUserRoleInicial)
        {
